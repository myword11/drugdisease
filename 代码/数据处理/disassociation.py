...
association_numbers_df = pd.read_csv(r"D:\a毕设\24.12.26_2101花葛药物-疾病相互作用课题\数据集\B-dataset\disAssociationNumber.csv")
...
# 保存最终结果
final_reordered.to_csv("D:/a毕设/24.12.26_2101花葛药物-疾病相互作用课题/数据集/B-dataset/未归一化/disAssociation.csv", index=False)
