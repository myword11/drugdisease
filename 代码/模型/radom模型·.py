...
datasets = [
    ...
    #     "output_dir": r"D:/a毕设/数据/十折/RF/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/RF/RF_KSU_欧几里得.csv"
    # },
    {
        "name": "NCR",
        "path": r"D:/a毕设/数据/未归一化/合并/NCR.csv",
        "output_dir": r"D:/a毕设/数据/十折/RF/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/RF/RF_NCR.csv"
    },
    # {
    #     "name": "NearMiss",
    #     "path": r"D:/a毕设/数据/未归一化/合并/NearMiss.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/RF/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/RF/RF_NearMiss.csv"
    # },
    # {
    #     "name": "OSS",
    #     "path": r"D:/a毕设/数据/未归一化/合并/OSS.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/RF/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/RF/RF_OSS.csv"
    # },
    # {
    #     "name": "Random",
    #     "path": r"D:/a毕设/数据/未归一化/合并/Random.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/RF/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/RF/RF_Random.csv"
    # },
    # {
    #     "name": "ClusterCentroids",
    #     "path": r"D:/a毕设/数据/未归一化/合并/ClusterCentroids.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/RF/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/RF/RF_ClusterCentroids.csv"
    # }
    # # 可以继续添加更多的数据集
]
...
model = RandomForestClassifier(
    ...
    max_depth=5,  # 进一步限制树的深度
    min_samples_split=15,  # 进一步增加分裂所需的最小样本数
    min_samples_leaf=10,  # 进一步增加叶子节点所需的最小样本数
...
for dataset in datasets:
    ...
    # 提取标签列
    y = df['label'].values  # 这里假设标签列已经存在并且列名为 'label'
