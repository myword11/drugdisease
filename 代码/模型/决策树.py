...
datasets = [

    {
        ...
        "output_dir": r"D:/a毕设/数据/十折/DT/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/DT/DT_KSU_欧几里得.csv"
    },
    {
        "name": "NCR",
        "path": r"D:/a毕设/数据/未归一化/合并/NCR.csv",
        "output_dir": r"D:/a毕设/数据/十折/DT/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/DT/DT_NCR.csv"
    },
    {
        "name": "NearMiss",
        "path": r"D:/a毕设/数据/未归一化/合并/NearMiss.csv",
        "output_dir": r"D:/a毕设/数据/十折/DT/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/DT/DT_NearMiss.csv"
    },
    {
        "name": "OSS",
        "path": r"D:/a毕设/数据/未归一化/合并/OSS.csv",
        "output_dir": r"D:/a毕设/数据/十折/DT/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/DT/DT_OSS.csv"
    },
    {
        "name": "Random",
        "path": r"D:/a毕设/数据/未归一化/合并/Random.csv",
        "output_dir": r"D:/a毕设/数据/十折/DT/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/DT/DT_Random.csv"
    },
    {
        "name": "ClusterCentroids",
        "path": r"D:/a毕设/数据/未归一化/合并/ClusterCentroids.csv",
        "output_dir": r"D:/a毕设/数据/十折/DT/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/DT/DT_ClusterCentroids.csv"
    }
    # 可以继续添加更多的数据集
]
