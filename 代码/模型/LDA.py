...
datasets = [
    ...
    #     "output_dir": r"D:/a毕设/数据/十折/lda/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/lda/lda_KSU_欧几里得.csv"
    # },
    {
        "name": "NCR",
        "path": r"D:/a毕设/数据/未归一化/合并/NCR.csv",
        "output_dir": r"D:/a毕设/数据/十折/lda/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/lda/lda_NCR.csv"
    },
    # {
    #     "name": "NearMiss",
    #     "path": r"D:/a毕设/数据/未归一化/合并/NearMiss.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/lda/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/lda/lda_NearMiss.csv"
    # },
    # {
    #     "name": "OSS",
    #     "path": r"D:/a毕设/数据/未归一化/合并/OSS.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/lda/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/lda/lda_OSS.csv"
    # },
    # {
    #     "name": "Random",
    #     "path": r"D:/a毕设/数据/未归一化/合并/Random.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/lda/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/lda/lda_Random.csv"
    # },
    # {
    #     "name": "ClusterCentroids",
    #     "path": r"D:/a毕设/数据/未归一化/合并/ClusterCentroids.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/lda/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/lda/lda_ClusterCentroids.csv"
    # }
    # 可以继续添加更多的数据集
]
...
for dataset in datasets:
    ...
    # 使用线性判别分析 (LinearDiscriminantAnalysis)
