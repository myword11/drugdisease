...
datasets = [
    ...
    #     "output_dir": r"D:/a毕设/数据/十折/svm/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/svm/svm_KSU_欧几里得.csv"
    # },
    {
        "name": "NCR",
        "path": r"D:/a毕设/数据/未归一化/合并/NCR.csv",
        "output_dir": r"D:/a毕设/数据/十折/svm/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/svm/svm_NCR.csv"
    },
    # {
    #     "name": "NearMiss",
    #     "path": r"D:/a毕设/数据/未归一化/合并/NearMiss.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/svm/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/svm/svm_NearMiss.csv"
    # },
    # {
    #     "name": "OSS",
    #     "path": r"D:/a毕设/数据/未归一化/合并/OSS.csv",
    #     "output_dir": r"D:/a毕设/数据/十折/svm/",
    #     "results_file": r"D:/a毕设/数据/未归一化/结果/svm/svm_OSS.csv"
    # },
    {
        "name": "Random",
        "path": r"D:/a毕设/数据/未归一化/合并/Random.csv",
        "output_dir": r"D:/a毕设/数据/十折/svm/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/svm/svm_Random.csv"
    },
    {
        "name": "ClusterCentroids",
        "path": r"D:/a毕设/数据/未归一化/合并/ClusterCentroids.csv",
        "output_dir": r"D:/a毕设/数据/十折/svm/",
        "results_file": r"D:/a毕设/数据/未归一化/结果/svm/svm_ClusterCentroids.csv"
    }
    # 可以继续添加更多的数据集
]
...
for dataset in datasets:
    ...
    for fold, (train_index, test_index) in enumerate(kf.split(X, y), 1):
        ...
        y_pred_prob = best_model.decision_function(X_test)  # 获取决策函数值作为概率估计
