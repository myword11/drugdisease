...
if __name__ == '__main__':
        ...
        #  'DecisionTree': r'D:\a毕设\数据\未归一化\特征选择数据\140\f_classif_汉明140.csv',
         ...
         # 'XGBoost': r'D:\a毕设\数据\未归一化\特征选择数据\160\f_classif_汉明160.csv',
           'RandomForest': r'D:\a毕设\数据\未归一化\特征选择数据\90\f_classif_切比雪夫90.csv',
            ...
            # 'DNN': r'D:\a毕设\数据\未归一化\合并\KSU_欧几里得.csv',
           #  'DecisionTree': r'D:\a毕设\数据\未归一化\合并\KSU_欧几里得.csv',
         # 'TextRCNN': r'D:\a毕设\数据\未归一化\合并\KSU_欧几里得.csv',
           # 'XGBoost': r'D:\a毕设\数据\未归一化\合并\KSU_欧几里得.csv',
           # 'RandomForest': r'D:\a毕设\数据\未归一化\合并\KSU_欧几里得.csv',
    }
    # 定义结果保存路径
    ...
    # 定义结果文件名
    results_output_path = os.path.join(results_folder, 'RF+DNN+TextRCNN.csv')
    # 获取所有模型
