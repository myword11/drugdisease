...
def load_data(file_path):
    ...
    X = data.iloc[:, 3:157].values.astype('float32')
...
def main(data_path, results_output_path, models_to_use, epochs=20, batch_size=64, learning_rate=0.001, n_splits=10, early_stopping_patience=5):
    ...
    for train_index, test_index in kf.split(X):
        ...
        for model_name, model_class in models_to_use.items():
            ...
            # 初始化模型
            model = initialize_model(model_class, input_size=154, output_size=1)
...
if __name__ == '__main__':
    data_paths = [
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\Correlation_汉明90.csv',
    #      r'D:\a毕设\数据\KSU下采样\特征选择\90\Correlation_曼哈顿90.csv',
    #    r'D:\a毕设\数据\KSU下采样\特征选择\90\Correlation_闵可夫斯基90.csv',
    #       r'D:\a毕设\数据\KSU下采样\特征选择\90\Correlation_欧几里得90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\Correlation_切比雪夫90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\Random_汉明90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\Random_曼哈顿90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\Random_闵可夫斯基90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\Random_欧几里得90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\Random_切比雪夫90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\RFE_汉明90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\RFE_曼哈顿90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\RFE_闵可夫斯基90.csv',
       r'D:\a毕设\数据\KSU下采样\特征选择\90\RFE_欧几里得90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\RFE_切比雪夫90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\SHAP_汉明90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\SHAP_曼哈顿90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\SHAP_闵可夫斯基90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\SHAP_欧几里得90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\SHAP_切比雪夫90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\卡方_汉明90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\卡方_曼哈顿90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\卡方_闵可夫斯基90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\卡方_欧几里得90.csv',
    #     r'D:\a毕设\数据\KSU下采样\特征选择\90\卡方_切比雪夫90.csv',
        # 你可以在此添加更多数据集路径
    ]
