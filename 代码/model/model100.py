...
def load_data(file_path):
    ...
    X = data.iloc[:, 3:167].values.astype('float32')
...
def main(data_path, results_output_path, models_to_use, epochs=20, batch_size=64, learning_rate=0.001, n_splits=10,
    ...
    for train_index, test_index in kf.split(X):
        ...
        for model_name, model_class in models_to_use.items():
            ...
            # 初始化模型
            model = initialize_model(model_class, input_size=164, output_size=1)
...
if __name__ == '__main__':
    data_paths = [
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\Correlation_汉明100.csv',
        #  r'D:\a毕设\数据\KSU下采样\特征选择\100\Correlation_曼哈顿100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\Correlation_闵可夫斯基100.csv',
        #   r'D:\a毕设\数据\KSU下采样\特征选择\100\Correlation_欧几里得100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\Correlation_切比雪夫100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\Random_汉明100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\Random_曼哈顿100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\Random_闵可夫斯基100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\Random_欧几里得100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\Random_切比雪夫100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\RFE_汉明100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\RFE_曼哈顿100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\RFE_闵可夫斯基100.csv',
        r'D:\a毕设\数据\KSU下采样\特征选择\100\RFE_欧几里得100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\RFE_切比雪夫100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\SHAP_汉明100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\SHAP_曼哈顿100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\SHAP_闵可夫斯基100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\SHAP_欧几里得100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\SHAP_切比雪夫100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\卡方_汉明100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\卡方_曼哈顿100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\卡方_闵可夫斯基100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\卡方_欧几里得100.csv',
        # r'D:\a毕设\数据\KSU下采样\特征选择\100\卡方_切比雪夫100.csv',
        # 你可以在此添加更多数据集路径
    ]
    results_folder = r'D:\a毕设\数据\KSU下采样\传统算法结果\DNN'
    # 确保目标文件夹存在
