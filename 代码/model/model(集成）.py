...
def main(data_path, results_output_path, models_to_use, epochs=20, batch_size=64, learning_rate=0.001, n_splits=10, early_stopping_patience=5):
    ...
    X = dataset.tensors[0]
    y = dataset.tensors[1]
    input_size = X.shape[1]  # 动态获取输入数据的特征维度
    # 初始化 KFold
...
if __name__ == '__main__':
    data_paths = [
        ...
        #  r'D:\a毕设\数据\未归一化\特征选择数据\90\Correlation_切比雪夫90.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\100\Correlation_曼哈顿100.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\110\Correlation_曼哈顿110.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\120\Correlation_曼哈顿120.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\130\Correlation_曼哈顿130.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\140\Correlation_曼哈顿140.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\150\Correlation_曼哈顿150.csv',
        #  r'D:\a毕设\数据\未归一化\特征选择数据\90\f_classif_切比雪夫90.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\100\f_classif_曼哈顿100.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\110\f_classif_曼哈顿110.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\120\f_classif_曼哈顿120.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\130\f_classif_曼哈顿130.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\140\f_classif_曼哈顿140.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\150\f_classif_曼哈顿150.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\90\SHAP_切比雪夫90.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\100\SHAP_切比雪夫100.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\110\SHAP_切比雪夫110.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\120\SHAP_切比雪夫120.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\130\SHAP_切比雪夫130.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\140\SHAP_切比雪夫140.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\150\SHAP_切比雪夫150.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\90\RFE_切比雪夫90.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\100\RFE_切比雪夫100.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\110\RFE_切比雪夫110.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\120\RFE_切比雪夫120.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\130\RFE_切比雪夫130.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\140\RFE_切比雪夫140.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\150\RFE_切比雪夫150.csv',
        r'D:\a毕设\数据\未归一化\特征选择数据\70\Random_切比雪夫70.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\90\Random_切比雪夫90.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\100\Random_切比雪夫100.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\110\Random_切比雪夫110.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\120\Random_切比雪夫120.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\130\Random_切比雪夫130.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\140\Random_切比雪夫140.csv',
        # r'D:\a毕设\数据\未归一化\特征选择数据\150\Random_切比雪夫150.csv',

        # 你可以在此添加更多数据集路径
    ]
    results_folder = r'D:\a毕设\数据\未归一化\特征选择结果\TextRCNN'
    # 确保目标文件夹存在
